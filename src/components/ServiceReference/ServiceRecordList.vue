<template>
  <div>
    <div
      v-if="serviceRecordItems === null"
      class="flex items-center justify-center"
    >
      <q-circular-progress indeterminate rounded size="30px" color="primary" />
    </div>
    <template v-else-if="serviceRecordItems.length === 0 || response === 404">
      ...
      <ol class="relative border-l border-gray-200">
        ...
        >
          <span
            ...
            :style="[
              i === 0 ? 'box-shadow: 0px 4px 20px rgba(75, 68, 246, 0.3);' : '',
            ]"
          >
            {{ i + 1 }}
          </span>
...
const props = defineProps({
  response: { type: Number, default: () => 200 },
});
