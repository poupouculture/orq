  ...
  <q-dialog v-model="deletedialog" persistent class="dialog-class">
      <q-card class="card-class">
        ...
        <q-card-actions align="right" class="btn-hld">
          <q-btn color="primary" label="Cancel" v-close-popup  outline class="dialogbtn-cls"/>

          <q-btn color="primary" label="Delete" v-close-popup class="dialogbtn-cls"/>
        </q-card-actions>
      </q-card>
    </q-dialog>
    <q-dialog v-model="savedialog" persistent class="dialog-class">
      <q-card class="card-class">
        ...
        <q-card-actions align="right" class="btn-hld">
          <q-btn color="primary" label="Discard Changes" v-close-popup  outline class="dialogbtn-cls"/>

          <q-btn color="primary" label="Keep Editing" v-close-popup class="dialogbtn-cls" />
        </q-card-actions>
      </q-card>
    </q-dialog>
  <div>
    <div class="q-pa-md">
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <q-input  v-model="date" mask="####-##-##" :rules="['date']" dense outlined bg-color = "white">
      ...
      <div class="row">
        <div class="col">
          ...
          <q-select outlined v-model="position" :options="positiondata" dense />        </div>
        <div class="col">
...
<div class="btn-hold">
  <div class="btn-cls" @click="deletedialog = true">
         ...
         <q-btn color="primary" label="Save" class="dark-btn"  @click="savedialog = true"/>
