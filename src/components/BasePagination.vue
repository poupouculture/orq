<template>
  <q-pagination v-model="pagination" @update:model-value="updateModel" :max="max" :max-pages="maxPages" direction-links active-design="outline" outline
    color="grey-7" active-color="primary" padding="6px 14px" />
</template>
<script setup>
import { ref } from "vue";
defineProps({
