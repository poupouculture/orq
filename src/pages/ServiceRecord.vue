    ...
    >
      <template v-slot:body-cell-Abstract="props">
        <q-td :props="props">
          ...
          <p class="text-xs text-gray-400 mt-1 font-normal"><span class="description -ml-1">测试1</span></p>
        </q-td>
      </template>
      ...
      <template v-slot:bottom>
        <Pagination :total="97" :current="pagination.page" :size="pagination.rowsPerPage" />
      </template>
    </q-table>
  </div>
</template>
...
const show = ref(true),
  columns = [
    ...
    { name: 'Abstract', label: 'Abstract', field: 'Abstract', align: 'left', headerStyle: 'width: 300px', headerClasses: 'header' },
    { name: 'auth', label: '', field: 'auth', align: 'left', headerStyle: 'width: 300px', headerClasses: 'header' },
    { name: 'Transaction', label: 'Transaction', field: 'Transaction', align: 'left', headerStyle: 'width: 300px', headerClasses: 'header' },
    { name: 'ServiceResults', label: 'Service results', field: 'ServiceResults', align: 'left', headerStyle: 'width: 300px', headerClasses: 'header' },
    { name: 'StartTime', label: 'Start time', field: 'StartTime', align: 'left', headerStyle: 'width: 260px', headerClasses: 'header' },
    { name: 'Operation', label: 'Operation', field: 'Operation', align: 'left', headerStyle: 'width: 100px', headerClasses: 'header' }
  ],
  rows = [],
  pagination = ref({
    page: 1,
