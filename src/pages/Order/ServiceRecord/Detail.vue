<template>
  <div class="pt-4">
    ...
    <div class="px-6 py-5 bg-white rounded-2xl" v-if="serviceReferenceItem">
      <BaseTimeline :items="serviceReferenceItem.service_records">
        <template v-slot="{ item }">
          <div class="bg-timeline-content px-5 py-3 rounded-2xl -mt-7">
            <div class="mb-3">
            ...
            <div class="flex items-center gap-y-3 lg:gap-x-10 lg:gap-y-0">
              ...
              <div class="flex flex-col w-1/2 lg:w-auto items-center">
                ...
                <p class="text-[#9A9AAF] text-sm">{{ item.company_name }}</p>
              </div>
              <div class="flex flex-col w-1/2 lg:w-auto items-center">
              ...
              <div class="flex flex-col w-1/2 lg:w-auto items-center">
                ...
                <p class="text-[#9A9AAF] text-sm">{{ item.remarks || "-" }}</p>
              </div>
            </div>
            <div
            ...
            >
              ...
              >
                ...
                <div class="font-semibold lg:pl-4" v-if="item.type === 'convo'">
                  During Conversation
                </div>
              </div>
              <div
...
import BaseTimeline from "src/components/BaseTimeline.vue";
...
const serviceReferenceItem = computed(() => serviceRecordStore.item);
const route = useRoute();
const toggleConvertationLog = () => {
  showConversationLog.value = !showConversationLog.value;
};
onMounted(async () => {
  await serviceRecordStore.get(route.params.id);
});
</script>
<style scoped>
.bg-timeline-content {
